...
namespace Bb.Curl.Commands
{
    ...
    public static class CurlParserExtension
    {
        ...
        {
            var interpreter = new CurlInterpreter(ParseCurlLine(lineArg));
        ...
        {
            var e = ResultToStringAsync(self, ensureSuccessStatusCode, cancellationToken);
            e.Wait();
            return e.Result;
        }
        ...
        {
            var e = ResultToJsonAsync<T>(self, ensureSuccessStatusCode, options, cancellationToken);
            e.Wait();
            return e.Result;
        }
        ...
        {
            var e = ResultToJsonAsync(self, type, ensureSuccessStatusCode, options, cancellationToken);
            e.Wait();
            return e.Result;
        }
        ...
        {
            var e = ResultToByteArrayAsync(self, ensureSuccessStatusCode, cancellationToken);
            e.Wait();
            return e.Result;
        }
        ...
        {
            var e = ResultToStreamAsync(self, ensureSuccessStatusCode, cancellationToken);
            e.Wait();
            return e.Result;
        }
