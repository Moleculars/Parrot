...
namespace Bb.Middlewares.Exceptions
{
    ...
    /// </summary>
    public static partial class CustomExceptionHandlerExtensions
    {
        /// <summary>
        ...
        /// <returns></returns>
        public static IApplicationBuilder UseCustomExceptionHandler(this IApplicationBuilder app, string errorHandlingPath)
        {
            if (app == null)
            {
                throw new ArgumentNullException(nameof(app));
        ...
        /// <returns></returns>
        public static IApplicationBuilder UseCustomExceptionHandler(this IApplicationBuilder app, ExceptionHandlerOptions options)
        {
            if (app == null)
            {
                throw new ArgumentNullException(nameof(app));
        ...
        private static IApplicationBuilder SetExceptionHandlerMiddleware(IApplicationBuilder app, IOptions<ExceptionHandlerOptions>? options)
        {
            ...
            if (app.Properties.TryGetValue(globalRouteBuilderKey, out var routeBuilder) && routeBuilder is not null)
            {
                return app.Use(next =>
                {
                    ...
                    return new CustomExceptionHandlerMiddleware(next, loggerFactory, options, diagnosticListener).Invoke;
                });
            }
            ...
            return app.UseMiddleware<CustomExceptionHandlerMiddleware>(options);
        }
